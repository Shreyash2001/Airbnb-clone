...
export const getInPersonExperienceReducer = (state = {inPersonExperience: []}, action) => {
    switch (action.type) {
        case EXPERIENCE_IN_PERSON_REQUEST:
            return {
                loading: true
            }
        case EXPERIENCE_IN_PERSON_SUCCESS:
            
            return {
                loading: false,
                inPersonExperience: action.payload
            }
        case EXPERIENCE_IN_PERSON_FAIL:
            return {
                loading: false,
                error: action.payload
            }
...
export const getAdventureExperienceReducer = (state = {adventure: []}, action) => {
    switch (action.type) {
        case EXPERIENCE_ADVENTURE_REQUEST:
            return {
                loading: true
            }
        case EXPERIENCE_ADVENTURE_SUCCESS:
            
            return {
                loading: false,
                adventure: action.payload
            }
        case EXPERIENCE_ADVENTURE_FAIL:
            return {
                loading: false,
                error: action.payload
            }
...
export const getCreatedByUserExperienceReducer = (state = {createdByUserExperiences: []}, action) => {
    switch (action.type) {
        case EXPERIENCE_GET_CREATEDBYUSER_REQUEST:
            return {
                loading: true
            }
        case EXPERIENCE_GET_CREATEDBYUSER_SUCCESS:
            
            return {
                loading: false,
                createdByUserExperiences: action.payload
            }
        case EXPERIENCE_GET_CREATEDBYUSER_FAIL:
            return {
                loading: false,
                error: action.payload
            }
...
export const getUpdatedExperienceReducer = (state = {updatedExperiences: []}, action) => {
    switch (action.type) {
        case EXPERIENCE_UPDATE_DETAILS_REQUEST:
            return {
                loading: true
            }
        case EXPERIENCE_UPDATE_DETAILS_SUCCESS:
            
            return {
                loading: false,
                updatedExperiences: action.payload,
                success: true
            }
        case EXPERIENCE_UPDATE_DETAILS_FAIL:
            return {
                loading: false,
                error: action.payload
            }
