import { EXPERIENCE_ADVENTURE_FAIL,
     EXPERIENCE_ADVENTURE_REQUEST,
      EXPERIENCE_ADVENTURE_SUCCESS,
       EXPERIENCE_AGE_FAIL,
       EXPERIENCE_AGE_REQUEST,
       EXPERIENCE_AGE_SUCCESS,
       EXPERIENCE_AVAILABILITY_FAIL,
       EXPERIENCE_AVAILABILITY_REQUEST,
       EXPERIENCE_AVAILABILITY_SUCCESS,
       EXPERIENCE_BROADCAST_FAIL,
       EXPERIENCE_BROADCAST_REQUEST,
       EXPERIENCE_BROADCAST_SUCCESS,
       ...
       EXPERIENCE_DESCRIPTION_FAIL,
       EXPERIENCE_DESCRIPTION_REQUEST,
       EXPERIENCE_DESCRIPTION_SUCCESS,
       EXPERIENCE_GET_CHILD_EXPERIENCE_FAIL,
       EXPERIENCE_GET_CHILD_EXPERIENCE_REQUEST,
        EXPERIENCE_GET_CHILD_EXPERIENCE_SUCCESS,
        EXPERIENCE_GET_COOKING_FAIL,
        EXPERIENCE_GET_COOKING_REQUEST,
        EXPERIENCE_GET_COOKING_SUCCESS,
        EXPERIENCE_GET_CREATEDBYUSER_FAIL,
        EXPERIENCE_GET_CREATEDBYUSER_REQUEST,
        EXPERIENCE_GET_CREATEDBYUSER_SUCCESS,
        EXPERIENCE_GET_EVERYDAY_EXPERIENCE_FAIL,
        EXPERIENCE_GET_EVERYDAY_EXPERIENCE_REQUEST,
        EXPERIENCE_GET_EVERYDAY_EXPERIENCE_SUCCESS,
        EXPERIENCE_GET_EXPERIENCEBYID_RESULT_FAIL,
        EXPERIENCE_GET_EXPERIENCEBYID_RESULT_REQUEST,
        EXPERIENCE_GET_EXPERIENCEBYID_RESULT_SUCCESS,
        EXPERIENCE_GET_FAIL,
        EXPERIENCE_GET_FILTERED_RESULT_FAIL,
        EXPERIENCE_GET_FILTERED_RESULT_REQUEST,
        EXPERIENCE_GET_FILTERED_RESULT_SUCCESS,
        EXPERIENCE_GET_LAST_WEEK_FAIL,
        EXPERIENCE_GET_LAST_WEEK_REQUEST,
        EXPERIENCE_GET_LAST_WEEK_SUCCESS,
        EXPERIENCE_GET_MAIN_FILTER_RESULT_FAIL,
        EXPERIENCE_GET_MAIN_FILTER_RESULT_REQUEST,
        EXPERIENCE_GET_MAIN_FILTER_RESULT_SUCCESS,
        EXPERIENCE_GET_POPULAR_IN_INDIA_FAIL,
        EXPERIENCE_GET_POPULAR_IN_INDIA_REQUEST,
        EXPERIENCE_GET_POPULAR_IN_INDIA_SUCCESS,
        EXPERIENCE_GET_REQUEST,
        EXPERIENCE_GET_SIMILAR_EXPERIENCE_FAIL,
        EXPERIENCE_GET_SIMILAR_EXPERIENCE_REQUEST,
        EXPERIENCE_GET_SIMILAR_EXPERIENCE_SUCCESS,
         EXPERIENCE_GET_SUCCESS,
         EXPERIENCE_GET_TEAM_EXPERIENCE_FAIL,
         EXPERIENCE_GET_TEAM_EXPERIENCE_REQUEST,
         EXPERIENCE_GET_TEAM_EXPERIENCE_SUCCESS,
         EXPERIENCE_GET_TOP_RATED_EXPERIENCE_FAIL,
          EXPERIENCE_GET_TOP_RATED_EXPERIENCE_REQUEST,
          EXPERIENCE_GET_TOP_RATED_EXPERIENCE_SUCCESS,
          EXPERIENCE_IMAGES_FAIL,
          EXPERIENCE_IMAGES_REQUEST,
          EXPERIENCE_IMAGES_SUCCESS,
          EXPERIENCE_IN_PERSON_FAIL,
           EXPERIENCE_IN_PERSON_REQUEST,
           EXPERIENCE_IN_PERSON_SUCCESS,
           EXPERIENCE_ISHOSTED_FAIL,
           EXPERIENCE_ISHOSTED_REQUEST,
           EXPERIENCE_ISHOSTED_SUCCESS,
           EXPERIENCE_ITEMS_FAIL,
           EXPERIENCE_ITEMS_REQUEST,
           EXPERIENCE_ITEMS_SUCCESS,
           EXPERIENCE_LANGUAGE_FAIL,
           EXPERIENCE_LANGUAGE_REQUEST,
           EXPERIENCE_LANGUAGE_SUCCESS,
           EXPERIENCE_LOCATION_FAIL,
           EXPERIENCE_LOCATION_REQUEST,
           EXPERIENCE_LOCATION_SUCCESS,
           EXPERIENCE_NUMBER_OF_HOURS_FAIL,
           EXPERIENCE_NUMBER_OF_HOURS_REQUEST,
           EXPERIENCE_NUMBER_OF_HOURS_SUCCESS,
           EXPERIENCE_PRICE_FAIL,
           EXPERIENCE_PRICE_REQUEST,
           EXPERIENCE_PRICE_SUCCESS,
           EXPERIENCE_SKILLS_FAIL,
           EXPERIENCE_SKILLS_REQUEST,
           EXPERIENCE_SKILLS_SUCCESS,
           EXPERIENCE_STORY_FAIL,
           EXPERIENCE_STORY_REQUEST,
           EXPERIENCE_STORY_SUCCESS,
           EXPERIENCE_SUBMIT_FAIL,
           EXPERIENCE_SUBMIT_REQUEST,
           EXPERIENCE_SUBMIT_SUCCESS,
           EXPERIENCE_THEME_FAIL,
           EXPERIENCE_THEME_REQUEST,
           EXPERIENCE_THEME_SUCCESS,
           EXPERIENCE_TIME_FAIL,
           EXPERIENCE_TIME_REQUEST,
           EXPERIENCE_TIME_SUCCESS,
           EXPERIENCE_TITLE_FAIL,
           EXPERIENCE_TITLE_REQUEST,
           EXPERIENCE_TITLE_SUCCESS,
           EXPERIENCE_TYPE_FAIL,
           EXPERIENCE_TYPE_REQUEST,
           EXPERIENCE_TYPE_SUCCESS,
           EXPERIENCE_UPDATE_DETAILS_FAIL,
           EXPERIENCE_UPDATE_DETAILS_REQUEST,
           EXPERIENCE_UPDATE_DETAILS_SUCCESS,
           EXPERIENCE_WORKING_FAIL,
           EXPERIENCE_WORKING_REQUEST,
           EXPERIENCE_WORKING_SUCCESS } from "../constants/experienceConstants"
...
export const getCreatedByUserExperiences = () => async (dispatch, getState) => {
   
    try {
        dispatch({ type: EXPERIENCE_GET_CREATEDBYUSER_REQUEST });
       ...
       const {data} = await axios.get(`/experience/created-by-user`, config)

        dispatch({
            type: EXPERIENCE_GET_CREATEDBYUSER_SUCCESS,
            payload: data
        })

    } catch (error) {
        dispatch({
            type:EXPERIENCE_GET_CREATEDBYUSER_FAIL,
            payload: error.response && error.response.data.message ? error.response.data.message : error.message
        })
    }
}
...
export const getUpdatedExperiences = (id, title, price, image) => async (dispatch, getState) => {
   
    try {
        dispatch({ type: EXPERIENCE_UPDATE_DETAILS_REQUEST });
       ...
       const {data} = await axios.put(`/experience/update-details`, {id, title, price, image}, config)

        dispatch({
            type: EXPERIENCE_UPDATE_DETAILS_SUCCESS,
            payload: data
        })

    } catch (error) {
        dispatch({
            type:EXPERIENCE_UPDATE_DETAILS_FAIL,
            payload: error.response && error.response.data.message ? error.response.data.message : error.message
        })
    }
}

export const deleteExperiences = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        await axios.delete(`/experience/delete-experience/${id}`, config)
